...
A new pattern is called Pattern and a number no other pattern has, and auto naming a track's clips
calls its patterns after the track, numbered in the order they first play.
